        ...
        <div className="max-w-sm sm:max-w-7xl mx-4 sm:mx-auto mt-16" >
            ...
            <ul className="timeline timeline-vertical">
                ...
                <li className="mx-8" >
                    ...
                    <div className="timeline-start timeline-box rounded-lg p-0 mr-8 w-full">
                        <div className="max-w-md m-4 space-y-4" >
                            <p className="text-lg font-semibold" >{t('gallery.udayana.title')}</p>
                            <p className="text-sm sm:text-base" >
                                {t('gallery.udayana.desc')}
                            </p>
                        </div>
                    </div>
                ...
                <li className="mx-8" >
                    ...
                    <div className="timeline-start timeline-box rounded-lg p-0 mr-8 w-full">
                        <div className="max-w-md m-4 space-y-4" >
                            <p className="text-lg font-semibold" >{t('gallery.simbol.title')}</p>
                            <p className="text-sm sm:text-base" >
                                {t('gallery.simbol.desc')}
                            </p>
                        </div>
                    </div>
                ...
                <li className="mx-8" >
                    ...
                    <div className="timeline-start timeline-box rounded-lg p-0 mr-8 w-full">
                        <div className="max-w-md m-4 space-y-4" >
                            <p className="text-lg font-semibold" >{t('gallery.pancuran.title')}</p>
                            <p className="text-sm sm:text-base" >
                                {t('gallery.pancuran.desc')}
                            </p>
                        </div>
                    </div>
                ...
                <li className="mx-8" >
                    ...
                    <div className="timeline-start timeline-box rounded-lg p-0 mr-8 w-full">
                        <div className="max-w-md m-4 space-y-4" >
                            <p className="text-lg font-semibold" >{t('gallery.mragayawati.title')}</p>
                            <p className="text-sm sm:text-base" >
                                {t('gallery.mragayawati.desc')}
                            </p>
                        </div>
                    </div>
                ...
                <li className="mx-8" >
                    ...
                    <div className="timeline-start timeline-box rounded-lg p-0 mr-8 w-full">
                        <div className="max-w-md m-4 space-y-4" >
                            <p className="text-lg font-semibold" >{t('gallery.mahkota.title')}</p>
                            <p className="text-sm sm:text-base" >
                                {t('gallery.mahkota.desc')}
                            </p>
                        </div>
                    </div>
                ...
                <li className="mx-8" >
                    ...
                    <div className="timeline-start timeline-box rounded-lg p-0 mr-8 w-full">
                        <div className="max-w-md m-4 space-y-4" >
                            <p className="text-lg font-semibold" >{t('gallery.lingga.title')}</p>
                            <p className="text-sm sm:text-base" >
                                {t('gallery.lingga.desc')}
                            </p>
                        </div>
                    </div>
                ...
                <li className="mx-8" >
                    ...
                    <div className="timeline-start timeline-box rounded-lg p-0 mr-8 w-full">
                        <div className="max-w-md m-4 space-y-4" >
                            <p className="text-lg font-semibold" >{t('gallery.jolotundo.title')}</p>
                            <p className="text-sm sm:text-base" >
                                {t('gallery.jolotundo.desc')}
                            </p>
                        </div>
                    </div>
                ...
                <li className="mx-8" >
                    ...
                    <div className="timeline-start timeline-box rounded-lg p-0 mr-8 w-full">
                        <div className="max-w-md m-4 space-y-4" >
                            <p className="text-lg font-semibold" >{t('gallery.lumpang.title')}</p>
                            <p className="text-sm sm:text-base" >
                                {t('gallery.lumpang.desc')}
                            </p>
                        </div>
                    </div>
                ...
                <li className="mx-8" >
                    ...
                    <div className="timeline-start timeline-box rounded-lg p-0 mr-8 w-full">
                        <div className="max-w-md m-4 space-y-4" >
                            <p className="text-lg font-semibold" >{t('gallery.pugar.title')}</p>
                            <p className="text-sm sm:text-base" >
                                {t('gallery.pugar.desc')}
                            </p>
                        </div>
                    </div>
                ...
                <li className="mx-8" >
                    ...
                    <div className="timeline-start timeline-box rounded-lg p-0 mr-8 w-full">
                        <div className="max-w-md m-4 space-y-4" >
                            <p className="text-lg font-semibold" >{t('gallery.naga.title')}</p>
                            <p className="text-sm sm:text-base" >
                                {t('gallery.naga.desc')}
                            </p>
                        </div>
