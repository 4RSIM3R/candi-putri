                ...
                <li className="mx-8">
                    ...
                    <div className="timeline-end timeline-box rounded-lg p-0 ml-8 w-full">
                        <div className="max-w-md m-4 space-y-4">
                            ...
                            <p className="text-sm sm:text-base">{t('gallery.gempeng.desc')}</p>
                        </div>
                    </div>
                    <hr />
                </li>
                ...
                <li className="mx-8">
                    ...
                    <div className="timeline-start timeline-box rounded-lg p-0 mr-8 w-full">
                        <div className="max-w-md m-4 space-y-4">
                            ...
                            <p className="text-sm sm:text-base">{t('gallery.saka.desc')}</p>
                        </div>
                    </div>
                    <div className="timeline-middle">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg>
                ...
                <li className="mx-8">
                    ...
                    <div className="timeline-end timeline-box rounded-lg p-0 ml-8 w-full">
                        <div className="max-w-md m-4 space-y-4">
                            ...
                            <p className="text-sm sm:text-base">{t('gallery.cungkup.desc')}</p>
                        </div>
                    </div>
                    <hr />
                </li>
                ...
                <li className="mx-8">
                    ...
                    <div className="timeline-start timeline-box rounded-lg p-0 mr-8 w-full">
                        <div className="max-w-md m-4 space-y-4">
                            ...
                            <p className="text-sm sm:text-base">{t('gallery.statue.desc')}</p>
                        </div>
                    </div>
                    <div className="timeline-middle">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg>
